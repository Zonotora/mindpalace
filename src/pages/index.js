...
const IndexPage = ({ data }) => {
  ...
  const { url, dirs, files } = { url: "", dirs: ["machine-learning","math","meta","networking","python","rust","web"], files: ["control-theory","latex","test"] };
  const [numberOfFiles, numberOfDirs ] = [37, 8];
