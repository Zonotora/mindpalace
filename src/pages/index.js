...
const IndexPage = ({ data }) => {
  ...
  const { url, dirs, files } = { url: "", dirs: ["art","databases","machine-learning","math","meta","networking","os","programming","web"], files: ["control-theory","latex"] };
  const [numberOfFiles, numberOfDirs ] = [54, 12];
