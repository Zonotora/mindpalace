...
const IndexPage = ({ data }) => {
  ...
  const { url, dirs, files } = { url: "/machine-learning", dirs: [], files: ["decision-tree","ensembles","feature-selection","hyperparameters","keywords","machine-learning","preprocessing","random-forests"] };
