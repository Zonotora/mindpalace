...
const IndexPage = ({ data }) => {
  ...
  const { url, dirs, files } = { url: "/math", dirs: [], files: ["calculus","distributions","keywords","linear-algebra","nonlinear-optimization","probability-theory","statistics","stochastic-processes"] };
